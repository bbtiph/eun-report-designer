...
public class CountriesResource {
    ...
    public ResponseEntity<Countries> updateCountries(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, countries.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Countries> partialUpdateCountries(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, countries.getId().toString())
        );
    }
