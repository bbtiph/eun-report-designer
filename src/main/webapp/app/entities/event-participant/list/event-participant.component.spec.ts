...
describe('EventParticipant Management Component', () => {
  let comp: EventParticipantComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'event-participant', component: EventParticipantComponent }]),
      ...
      .overrideTemplate(EventParticipantComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.eventParticipants?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to eventParticipantService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEventParticipantIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEventParticipantIdentifier).toHaveBeenCalledWith(entity);
