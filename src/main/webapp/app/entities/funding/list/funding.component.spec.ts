...
describe('Funding Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'funding', component: FundingComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.fundings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to fundingService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getFundingIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getFundingIdentifier).toHaveBeenCalledWith(entity);
