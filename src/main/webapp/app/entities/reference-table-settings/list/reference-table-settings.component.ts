...
@Component({
  selector: 'jhi-reference-table-settings',
  templateUrl: './reference-table-settings.component.html',
})
export class ReferenceTableSettingsComponent implements OnInit {
  ...
  delete(referenceTableSettings: IReferenceTableSettings): void {
    const modalRef = this.modalService.open(ReferenceTableSettingsDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.referenceTableSettings = referenceTableSettings;
